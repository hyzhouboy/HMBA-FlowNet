...
class CycleFlowModel(object):
    def __init__(self, batch_size=8, iter_steps=1000000, initial_learning_rate=1e-4, decay_steps=2e5, 
                 ...
                 cyclegan_restore_model='./models/KITTI/data_cyclegan', total_restore_model='./KITTI/models/total_model',
    ...
    def train(self, training_stage='first_stage'):
        if training_stage == 'first_stage':    
            ...
            with graph.as_default():
                ...
                var_consistency_restore = [val for val in self.trainable_vars if 'rain_flow' or 'derain_flow' in val.name]
            ...
            raise ValueError('Invalid training_stage. Training_mode should be one of {first_stage, second_stage, third_stage, forth_stage}')    
